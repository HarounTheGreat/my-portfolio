...
const Contact = () => {
  ...
  const sendEmail = async (e) => {
    ...
    try {
      ...
      // Use a more modern approach like a toast or notification for success
      alert("Message sent successfully!"); // Consider replacing this with a toast or other UI feedback
      e.target.reset(); // Reset form only on success
    } catch (error) {
